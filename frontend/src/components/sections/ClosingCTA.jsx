...
import { BUTTON_ICON_SIZE } from "@/constants/ui";
  ...
  return (
    <div className="lg:col-span-8">
      <FadeIn>
        ...
        <h2 className="display-lg" style={{ color: "#F2EDE0", maxWidth: "22ch", marginBottom: "1rem" }}>
        ...
        <p style={{ color: "#BFC3C8", maxWidth: "54ch" }}>
          ...
          decree, and the open questions — and write back with a clear, measured
          path forward.
        </p>
      </FadeIn>
    </div>
...
function ClosingActions() {
  return (
    <div className="lg:col-span-4 flex flex-col gap-3">
      ...
      >
        <PhoneCall size={BUTTON_ICON_SIZE} /> 215-782-9847
      </a>
    </div>
  );
}
