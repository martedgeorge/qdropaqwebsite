...
title: 'Articles',
description:
'Educational articles on pensions, QDROs, retirement valuation, and divorce-related financial issues.',
links: [
...
title: 'Div Tips',
description:
'Helpful guidance for avoiding common mistakes during divorce-related retirement division.',
links: [
['What Is a QDRO?', '/faq'],
...
description:
'Introductory resources for understanding pensions, survivor benefits, retirement age, and plan rules.',
links: [
...
return (
<> <section className="resourcesHero"> <p className="eyebrow">Resource Center</p> <h1>QDRO & Pension Division Library</h1> <p>
A professional resource library for articles, divorce tips, pension
education, and retirement division guidance. </p> </section>
            ...
            {group.links.map(([title, link]) => (
              ...
              >
                ...
                <p>
                  ...
                  division, pensions, QDROs, and divorce-related financial issues.
                </p>
